    ...
    def transfer_discount_loyalty(self, model_name, fields, description, date_from, date_to):
        try:
            ...
            reward_ids_lines = self.source_client.call_odoo('object', 'execute_kw', self.source_client.db,
                                                            ...
                                                            {'fields': ['reward_type', 'discount', 'discount_applicability', 'discount_max_amount', 'required_points', 'description', 'discount_mode', 'discount_product_domain', 'discount_product_ids', 'discount_product_category_id', 'vit_trxid', 'program_id', 'reward_product_id']})
            ...
            print(product_dict_reward, product_dict_rule, category_dict_reward, category_dict_rule, currency_dict, pricelist_dict, pos_config_dict)
            def process_create_discount(record):
                ...
                for line in current_reward_lines:
                    if isinstance(line, dict):
                        ...
                        rewards_product_id = line.get('reward_product_id', [])
                        rewards_target_product_id = [product_dict_reward.get(product['default_code']) for product in products_source_reward if product['id'] in rewards_product_id]
                    ...
                    discount_line_data = {
                        ...
                        'rewards_product_id': rewards_target_product_id[0] if rewards_target_product_id else False,  # Add rewards_product_id
        ...
        try:
            ...
            def process_update_discount(record):
                ...
                existing_reward_lines = self.target_client.call_odoo('object', 'execute_kw', self.target_client.db,
                                                                    ...
                                                                    'loyalty.reward', 'search_read',
                                                                    [[['program_id', '=', program_id]]],
                                                                    {'fields': ['id', 'reward_type', 'discount', 'discount_applicability', 'discount_max_amount', 'required_points', 'description', 'discount_product_ids', 'discount_product_category_id', 'vit_trxid', 'reward_product_id']})
                ...
                for line in current_reward_lines:
                    if isinstance(line, dict):
                        ...
                        rewards_product_id = line.get('rewards_product_id', [])
                        rewards_target_product_id = [product_dict_reward.get(product['default_code']) for product in products_source_reward if product['id'] in rewards_product_id]
                        ...
                        if existing_line:
                            if (existing_line['reward_type'] != line['reward_type'] or
                                ...
                                existing_line['reward_product_id'] != rewards_target_product_id[0] if rewards_target_product_id else False):
