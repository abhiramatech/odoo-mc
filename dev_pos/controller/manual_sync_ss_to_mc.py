...
class ManualSyncSSToMCIntegratiion(models.Model):
    ...
    def search_manual_sync(self):
        ...
        return store, date_from, date_to, master_customer_to_mc, master_employee_to_mc, session, end_shift, invoice, invoice_rescue,internal_transfers_to_mc, goods_receipts_to_mc, goods_issue_to_mc, receipts_to_mc, inventory_adjustment_to_mc, inventory_counting, ts_out, ts_in, grpo, vit_val_goods_receipts, vit_val_goods_issue
